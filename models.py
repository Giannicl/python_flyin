...
class Zone:
    ...
    def __str__(self) -> str:
        """Returns a human-readable string representation of the zone."""
...
class Connection:
    """Represents a bidirectional edge between two zones in the navigation graph.
...
class Drone:
    """Represents a drone navigating through the graph.
        ...
        Attributes:
            ...
            remaining_transit_turns: Number of turns left to complete current transit.
    """
